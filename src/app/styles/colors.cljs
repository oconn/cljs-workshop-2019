(ns app.styles.colors)

;; Themes pulled from Material UI style guide
;; for more themes, check out https://www.materialpalette.com/colors
...
(def ^{:private true} custom-colors
  {:error "#FF0300"
   :warning "#FF6600"
   :success "#00E062"
   :link "#009bff"})
