...
(def body-20-size 18)
(def body-10-size 16)
(def label-30-size 14)
(def label-20-size 14)
(def label-10-size 13)
(def caption-30-size 14)
(def caption-20-size 13)
(def caption-10-size 12)
...
(def size
  {:display-20 (->rounded-px display-20-size 1)
   ...
   :display-10 (->rounded-px display-20-size 1)
   :display-10/tablet (->rounded-px display-20-size 0.75)
   :display-10/mobile (->rounded-px display-20-size 0.58)
   ...
   :label-30 (->rounded-px caption-30-size 1)
   :label-30/tablet (->rounded-px label-30-size 0.90)
   :label-30/mobile (->rounded-px label-30-size 0.82)

   :label-20 (->rounded-px caption-20-size 1)
   :label-20/tablet (->rounded-px label-20-size 0.90)
   :label-20/mobile (->rounded-px label-20-size 0.82)

   :label-10 (->rounded-px caption-10-size 1)
   :label-10/tablet (->rounded-px label-10-size 0.90)
   :label-10/mobile (->rounded-px label-10-size 0.82)
